    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserRegistrationDto userRegistrationDto)
        {
            ...
            var newUser = new User
            {
                ...
                UsedCasualLeaves = 0,
                UsedEarnedLeaves = 0,
                IsManager = userRegistrationDto.IsManager,
                ManagerId = userRegistrationDto.ManagerId                  
            };

            var createdUser = await Repo.Register(newUser, userRegistrationDto.Password);

            var user = Mapper.Map<UserDto>(createdUser);
        ...
        public async Task<IActionResult> Login(UserLoginDto userLoginDto)
        {
            ...
            var user = Mapper.Map<UserDto>(storedUser);
